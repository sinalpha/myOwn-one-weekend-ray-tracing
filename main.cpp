...
int main() {
    ...
    auto aspetc_ratio = 16.0 / 9.0;
    int image_width = 400;

    // Calculate the image height, and ensure that it's at least 1.
    int image_height = int(image_width / aspetc_ratio);
    ...
    // Calculate the vectors across the horizontal and down the vertical viewport deges.
